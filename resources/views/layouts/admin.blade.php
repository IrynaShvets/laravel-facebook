        ...
        <div class="col-12 col-sm-3 col-xl-2 px-sm-2 px-0 bg-secondary d-flex sticky-top">
            <div class="d-flex flex-sm-column flex-row flex-grow-1 align-items-center align-items-sm-start px-3 pt-2 text-white">
                ...
                <ul class="nav nav-pills flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto mb-0 justify-content-center align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="#submenu1" data-bs-toggle="collapse" class="nav-link px-sm-0 px-2 text-dark">
                            <i class="fs-5 bi-speedometer2"></i><span class="ms-1 d-none d-sm-inline">Users</span> </a>
                    </li>
                    <li>
                        <a href="#" class="nav-link px-sm-0 px-2 text-dark">
                            <i class="fs-5 bi-table"></i><span class="ms-1 d-none d-sm-inline">Roles</span></a>
                    </li>
                    <li>
                        <a href="#" class="nav-link px-sm-0 px-2 text-dark">
                            <i class="fs-5 bi-table"></i><span class="ms-1 d-none d-sm-inline">Permissions</span></a>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="nav-link dropdown-toggle px-sm-0 px-1 text-dark" id="dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fs-5 bi-bootstrap"></i><span class="ms-1 d-none d-sm-inline">Posts</span>
                        </a>
                ...
                <div class="dropdown py-sm-4 mt-sm-auto ms-auto ms-sm-0 flex-shrink-1">
                    <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <span class="d-none d-sm-inline mx-1 text-dark">Palmo</span>
                    </a>
